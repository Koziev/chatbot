...
public static class AdverbCategory
{
    ...
    public static bool IsQuestionAdverb(string a)
    {
        return "где как зачем почему откуда куда сколько".Contains(a);
    }
    public static bool IsAppropriateForNeg(string a)
    {
        return !IsQuestionAdverb(a) && !"много немного ничуть".Contains(a);
    }
}
