        ...
        if premise is None:
            ...
            if self.who_are_you_counter == 1:
                ...
                sx = ['Жаль, что ты не хочешь рассказать, кто ты',
                      ...
                      'Как грустно, что ты не хочешь про себя рассказать'
            ...
            if self.activation_counter == 1:
                sx = ['Было приятно познакомиться',
                      'Вот и хорошо, что мы узнали кое-что друг про друга',
                      'Отлично, мы узнали друг про друга кое-что',
                      'спасибо за информацию!',
                      'благодарю за информацию!',
                      'спасибо за ценную информацию!',
                      'отлично, чем ты сейчас занимается?',
                      'чем сейчас занимаешься?',
                      'ты чем сейчас занимаешься?',
                      'что ты сейчас делаешь?',
                      'расскажи, что ты сейчас делаешь?',
                      'расскажи, чем ты сейчас занимаешься?',
                      'о чем мы будем с тобой разговаривать?',
                      'на какую тему предлагаешь пообщаться?',
