...
parser.add_argument('--metric', type=str, default='wmd', choices='jaccard wmd w2v'.split())
parser.add_argument('--word2vector', type=str, default='../../tmp/w2v.CBOW=1_WIN=5_DIM=64.bin', help='path to word2vector model dataset')
